...
function MatchesPage() {
    ...
    return(
        <div>
            <AppNavBar/>
            <div><h1 style={{textAlign: "center", margin: "2em 0em 1em"}}>Matches Page</h1></div>
            <div className="matches-league-week-container">
                ...
                <div className="matches-league-week-inner-container" style={{marginBottom: "3em"}}>
            ...
            {loading && matchesData ?
                ...
                {matchesData.map((singleMatchDetails) => {
                    return(<MatchBox key={singleMatchDetails._id} matchData={singleMatchDetails}/>)
                })}
                </div>
                :
