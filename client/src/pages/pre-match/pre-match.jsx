      ...
      <div>
        ...
        <div style={{margin:"2em"}}>
            <div className="row" style={{textAlign:"center",margin:"20px"}}>
                <div className="col-6 vote_border" style={{backgroundColor:"lightblue", margin:"10px"}}>
                    <p className="referee_name" style={{paddingTop:"10px"}}>Mete Kalkavan</p>
                </div>
                <div className="col-4 vote_border" style={{margin:"10px",backgroundColor:"lightblue"}}>
                    <div className="user_vote_stars" style={{paddingTop:"10px"}}><BsStar id="1"/><BsStar id="2"/><BsStar id="3"/><BsStar id="4"/><BsStar id="5"/></div>
                </div>
            </div>
            <div className="row" style={{textAlign:"center",margin:"20px"}}>
                <div className="col-6 vote_border" style={{backgroundColor:"lightblue", margin:"10px"}}>
            ...
            <div className="row" style={{textAlign:"center",margin:"20px"}}>
                ...
                <div className="col-4 vote_border" style={{margin:"10px",backgroundColor:"lightblue"}}>
                    <div className="user_vote_stars" style={{paddingTop:"10px"}}><BsStar style={{height: "50px"}} id="1"/><BsStar id="2"/><BsStar id="3"/><BsStar id="4"/><BsStar id="5"/></div>
                </div>
            </div>
        </div>
      </div>
